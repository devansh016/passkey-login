...
class ComposerStaticInitd59f9907213b20245d4b83074124c3b9
{
    ...
    public static $classMap = array (
        ...
        'Passkey_Login_Admin' => __DIR__ . '/../..' . '/includes/admin/class-passkey-login-admin.php',
        'Passkey_Login_Authenticator' => __DIR__ . '/../..' . '/includes/auth/class-passkey-login-authenticator.php',
        'Passkey_Login_Autoloader' => __DIR__ . '/../..' . '/includes/class-passkey-login-autoloader.php',
        'Passkey_Login_Capabilities' => __DIR__ . '/../..' . '/includes/class-passkey-login-capabilities.php',
        'Passkey_Login_Challenge' => __DIR__ . '/../..' . '/includes/auth/class-passkey-login-challenge.php',
        'Passkey_Login_Credential' => __DIR__ . '/../..' . '/includes/auth/class-passkey-login-credential.php',
        'Passkey_Login_Crypto' => __DIR__ . '/../..' . '/includes/utils/class-passkey-login-crypto.php',
        'Passkey_Login_Installer' => __DIR__ . '/../..' . '/includes/class-passkey-login-installer.php',
        'Passkey_Login_Logger' => __DIR__ . '/../..' . '/includes/utils/class-passkey-login-logger.php',
        'Passkey_Login_Login_Form' => __DIR__ . '/../..' . '/includes/frontend/class-passkey-login-login-form.php',
        'Passkey_Login_Network' => __DIR__ . '/../..' . '/includes/multisite/class-passkey-login-network.php',
        'Passkey_Login_Network_Admin' => __DIR__ . '/../..' . '/includes/admin/class-passkey-login-network-admin.php',
        'Passkey_Login_Network_Audit_List_Table' => __DIR__ . '/../..' . '/includes/admin/class-passkey-login-network-audit-list-table.php',
        'Passkey_Login_Network_Site_List_Table' => __DIR__ . '/../..' . '/includes/admin/class-passkey-login-network-site-list-table.php',
        'Passkey_Login_Plugin' => __DIR__ . '/../..' . '/includes/class-passkey-login-plugin.php',
        'Passkey_Login_REST_API' => __DIR__ . '/../..' . '/includes/api/class-passkey-login-rest-api.php',
        'Passkey_Login_Sanitizer' => __DIR__ . '/../..' . '/includes/utils/class-passkey-login-sanitizer.php',
        'Passkey_Login_Settings' => __DIR__ . '/../..' . '/includes/utils/class-passkey-login-settings.php',
        'Passkey_Login_Shortcodes' => __DIR__ . '/../..' . '/includes/frontend/class-passkey-login-shortcodes.php',
        'Passkey_Login_Site_Manager' => __DIR__ . '/../..' . '/includes/multisite/class-passkey-login-site-manager.php',
        'Passkey_Login_User_Profile' => __DIR__ . '/../..' . '/includes/admin/class-passkey-login-user-profile.php',
        'Passkey_Login_User_Sync' => __DIR__ . '/../..' . '/includes/multisite/class-passkey-login-user-sync.php',
        'Passkey_Login_WebAuthn' => __DIR__ . '/../..' . '/includes/auth/class-passkey-login-webauthn.php',
